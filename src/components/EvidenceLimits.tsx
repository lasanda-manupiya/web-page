...
export default function EvidenceLimits() {
  return (
    <section id="evidence" className="bg-navy-50" aria-labelledby="evidence-heading">
      <div className="mx-auto max-w-content px-4 py-12">
        <div className="flex items-center gap-3">
          <h2 id="evidence-heading" className="text-2xl font-bold text-navy-900">
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          <div className="rounded-panel border border-navy-200 bg-white p-4">
            <h3 className="font-semibold text-navy-900">What you are seeing</h3>
          ...
          <div className="rounded-panel border border-navy-200 bg-white p-4">
            <h3 className="font-semibold text-navy-900">What we need from you</h3>
            <ul className="mt-2 list-inside list-disc space-y-1 text-sm text-neutral-700">
